...
class BchService:
    BALANCE_PATH = "/explorer-gateway-kt/bch/address"
    TRANSACTIONS_PATH = "/explorer-gateway-kt/bch/address/transactions"
    ...
    def _normalize(address: str, raw: dict) -> dict:
        ...
        return {
            ...
            "balance_bch": satoshi_to_btc(confirmed_sat),
            "pending_bch": satoshi_to_btc(unconfirmed_sat),
            "received_bch": satoshi_to_btc(received_sat),
    ...
    # ------------------------------------------------------------------
    # Transactions (même structure que BTC)
    # ------------------------------------------------------------------
    ...
    def _normalize_tx(tx: dict, address: str) -> dict:
        ...
        return {
            ...
            "from": from_addr,
            "to": to_addr,
            "value_bch": satoshi_to_btc(value_sat),
            "value_sat": value_sat,
            "received_bch": satoshi_to_btc(received_sat),
            "sent_bch": satoshi_to_btc(sent_sat),
            "net_bch": satoshi_to_btc(net_sat),
            "fee_bch": satoshi_to_btc(tx.get("fee", 0)),
